 ...
 * st, so every setting here is baked into the binary. Edit here, then
 * `guix system reconfigure guix/config.scm` to rebuild.
 */
 ...
 * Button1Mask is always unset, to make masking less painful.
