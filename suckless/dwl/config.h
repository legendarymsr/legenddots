/* dwl — Tokyo Night. Adapted from dwl's config.def.h. */
...
static const float fullscreen_bg[]         = {0.101f, 0.106f, 0.149f, 1.0f}; /* Tokyo Night bg */
...
/* Super (logo) as the modifier, to match the rest of legenddots. */
